...
//////////////////////////////////////////////////////////////////////////////
        ...
        void Update()
        {
            ...
            if (mouse_held_down && !no_drawing_on_current_drag)//1.鼠标按下  2.是否继续画画
            {
                ...
                else
                {
                    ...
                    if (!mouse_was_previously_held_down)
                    {
                        ...
                        no_drawing_on_current_drag = true;//跑到图片外边去了
                    }
                }
            }
            // Mouse is released
        ...
        /// 非首次
        /// </summary>
        /// <param name="center_pixel"></param>
        /// <param name="pen_thickness"></param>
        ...
        public Vector2 WorldToPixelCoordinates(Vector2 world_position)
        {
            ...
            Vector3 local_pos = transform.InverseTransformPoint(world_position);//转换为本地坐标 
